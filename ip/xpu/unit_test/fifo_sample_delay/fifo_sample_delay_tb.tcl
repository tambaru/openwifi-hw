...
set _xil_proj_name_ "fifo_sample_delay_tb"
...
set script_file "fifo_sample_delay_tb.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/fifo_sample_delay_tb"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/fifo_sample_delay_tb.v"] \
]
...
set file "$origin_dir/fifo_sample_delay_tb.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "fifo_sample_delay_tb" -objects $obj
