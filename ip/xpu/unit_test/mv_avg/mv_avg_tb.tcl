...
#
# mv_avg_tb.tcl: Tcl script for re-creating project 'mv_avg_tb'
#
...
set orig_proj_dir "[file normalize "$origin_dir/mv_avg_tb"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/mv_avg_tb.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../src/mv_avg.v"
...
set file "$origin_dir/mv_avg_tb.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
